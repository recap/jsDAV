...
(function() {
    ...
    this.exec = function(req, resp) {
        new jsDAV_Handler(this, req, resp, this.auth);
    };
...
exports.createServer = function(options, port, host, auth) {
	if (auth) {
		console.log("1 has auth");
	}
	console.log(auth);
    port = port || exports.DEFAULT_PORT;
    host = host || exports.DEFAULT_HOST;

    var server = new Server(options, auth);
